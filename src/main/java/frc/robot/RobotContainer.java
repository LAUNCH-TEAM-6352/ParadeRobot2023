...
keyStopSpinningButton.whileTrue(new SpinKey(false, m_keyMotor).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton keyStartSpinningButton = new JoystickButton(xboxController1, XboxController.Button.kX.value);        
keyStartSpinningButton.whileTrue(new SpinKey(true, m_keyMotor).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
